...
const services: Record<string, ServiceCopy> = {
  ...
  'business-automation': {
    he: { title: 'אוטומציה עסקית עם AI | פחות עבודה ידנית', description: 'מיפוי והטמעה של אוטומציה עסקית עם AI לעסקים בישראל: פחות עבודה ידנית, פחות טעויות ותהליכים שאפשר למדוד.', h1: 'אוטומציה עסקית שמחזירה זמן לצוות', intro: 'מחברים בין המידע, התהליכים והכלים שכבר קיימים כדי להפחית עבודה ידנית בלי להכניס עוד שכבת רעש.', keywords: ['אוטומציה עסקית עם AI', 'אוטומציה לעסקים קטנים', 'ייעוץ אוטומציה עסקית', 'AI automation for SMBs', 'אוטומציה של תהליכים'], bullets: ['זיהוי משימות חוזרות שגוזלות זמן', 'תכנון זרימת עבודה עם נקודות בקרה', 'חיבור מערכות, מסמכים ומקורות מידע', 'מדידה של זמן, שגיאות ואיכות לפני ואחרי'], steps: [['01 / למפות', 'מזהים איפה העבודה הידנית מצטברת ואיפה היא מייצרת סיכון.'], ['02 / לחבר', 'מתכננים חיבורים בין הכלים שכבר נמצאים בשימוש.'], ['03 / לשלוט', 'מוסיפים בקרה, התראות ובעלות ברורה לכל תהליך.']], outcomes: ['פחות עבודה חוזרת', 'תהליכים ברורים יותר', 'יכולת למדוד את הערך של האוטומציה'], faqs: [{ question: 'איזה תהליכים אפשר להפוך לאוטומטיים?', answer: 'דוגמאות נפוצות הן דיווחים חוזרים, איסוף מידע, סיכום מסמכים, תיוג, בדיקות והעברת נתונים בין מערכות.' }, { question: 'האם אוטומציה עם AI בטוחה לעסק?', answer: 'כן, כאשר מתכננים הרשאות, נקודות אישור, פרטיות ובקרה אנושית כחלק מהמערכת — ולא אחרי ההשקה.' }] },
  ...
  'data-bi-dashboards': {
    he: { title: 'דשבורדים ו-BI לעסקים | נתונים להחלטות', description: 'ייעוץ דאטה, BI ודשבורדים לעסקים קטנים ובינוניים בישראל. הופכים נתונים מפוזרים לתמונה ניהולית שמניעה החלטות.', h1: 'דשבורד שאנשים באמת משתמשים בו', intro: 'בונים את התמונה הנכונה להנהלה — עם נתונים אמינים, הקשר עסקי והחלטות שאפשר לקבל מהר יותר.', keywords: ['דשבורד ניהולי', 'מערכת BI לעסקים', 'בינה עסקית לעסקים', 'דשבורד עסקי', 'ניתוח נתונים לעסקים'], bullets: ['הגדרת מדדי ביצוע לפי החלטות ניהוליות', 'חיבור מקורות מידע בלי לאבד הקשר', 'יצירת שכבת הגדרות ומילון מדדים', 'הצגה ברורה של חריגות, מגמות והזדמנויות'], steps: [['01 / להגדיר', 'מחליטים אילו החלטות הדשבורד צריך לשפר ואילו שאלות הוא חייב לענות.'], ['02 / לאחד', 'מחברים מקורות ומסכימים על הגדרות, בעלות ותדירות עדכון.'], ['03 / להנגיש', 'בונים תצוגה שמאפשרת להבין, לשאול ולפעול — לא רק להסתכל.']], outcomes: ['מדדים שהנהלה סומכת עליהם', 'פחות ויכוחים על המספרים', 'זמן קצר יותר מנתון להחלטה'], faqs: [{ question: 'האם חייבים להחליף את מערכת ה-BI?', answer: 'לא. פעמים רבות אפשר להתחיל מהגדרת השאלות, המדדים והחיבורים לפני שמחליפים כלי.' }, { question: 'למי מתאים דשבורד ניהולי?', answer: 'לעסקים שרוצים תמונת מצב אחת של מכירות, תפעול, שיווק, כספים או לקוחות — עם יכולת לרדת לפרטים כשצריך.' }] },
  ...
  'analytics-consulting': {
    he: { title: 'ייעוץ דאטה ואנליטיקה | מדאטה להחלטה', description: 'ייעוץ דאטה ואנליטיקה להנהלות בישראל: סדר עדיפויות, תהליכי עבודה וכלים שמחברים בין הנתונים לתוצאות העסקיות.', h1: 'מדאטה מפוזר להחלטה שאפשר לפעול לפיה', intro: 'עוזרים לארגון לחבר בין המטרות העסקיות, הדאטה והעבודה היומיומית — בלי להיתקע בפרויקט תשתית אינסופי.', keywords: ['ייעוץ דאטה ואנליטיקה', 'ניתוח נתונים לעסקים', 'data analytics consulting israel', 'אסטרטגיית דאטה', 'ייעוץ אנליטיקה עסקית'], bullets: ['מיפוי שאלות עסקיות ומקורות נתונים', 'תעדוף יוזמות לפי ערך ומאמץ', 'שיפור תהליך האנליזה והדיווח', 'ליווי הנהלה וצוותים בקבלת החלטות מבוססת נתונים'], steps: [['01 / לשאול', 'מנסחים את השאלות העסקיות לפני שבוחרים כלי.'], ['02 / לחבר', 'מייצרים קשר בין הנתונים, התהליך והאחריות של הצוות.'], ['03 / ללמוד', 'מודדים מה השתפר ומעדכנים את הדרך לפי מה שקורה בפועל.']], outcomes: ['סדר עדיפויות ברור', 'תהליכי אנליזה עקביים', 'שיתוף פעולה טוב יותר בין עסק, דאטה וטכנולוגיה'], faqs: [{ question: 'מה ההבדל בין ייעוץ דאטה לייעוץ BI?', answer: 'ייעוץ דאטה מסתכל על השאלות, התהליכים והמקורות; BI הוא אחד הכלים האפשריים להפוך את ההחלטות האלה לתפעול יומיומי.' }, { question: 'האם השירות מתאים לעסק בלי צוות דאטה?', answer: 'כן. אפשר להתחיל ממיפוי צרכים ודרך עבודה פשוטה, ולהחליט בהמשך מה כדאי לבנות פנימה ומה נכון לקבל מבחוץ.' }] },
  ...
  'ai-workshops': {
    he: { title: 'סדנת AI לעובדים | שימוש מעשי ובטוח', description: 'סדנאות AI מעשיות לעובדים ולהנהלות בישראל: שימושים אמיתיים, עבודה בטוחה ותכנית פעולה שמתחילה כבר ביום הראשון.', h1: 'סדנת AI שיוצאת מהחדר אל העבודה', intro: 'מייצרים לצוות שפה משותפת, שימוש בטוח והרגלים שמתחברים לתהליכים האמיתיים של העסק.', keywords: ['סדנת AI לעובדים', 'הדרכת AI לעסקים', 'סדנת בינה מלאכותית', 'ai workshop for businesses', 'הטמעת AI בארגון'], bullets: ['מיפוי שימושים לפי תפקיד ותהליך', 'תרגול על דוגמאות מהעסק', 'כללי פרטיות, אבטחה ובקרת איכות', 'תכנית 30 יום להמשך שימוש ומדידה'], steps: [['01 / להקשר', 'מתחילים מהעבודה שהצוות כבר עושה ומהתסכולים שחוזרים עליה.'], ['02 / לתרגל', 'מנסים כלים וטכניקות על בעיות אמיתיות, לא על דוגמאות כלליות.'], ['03 / להמשיך', 'מסיימים עם תרגול המשך, כללי שימוש ותעדוף צעדים.']], outcomes: ['שפה משותפת סביב AI', 'יותר ביטחון בשימוש בכלים', 'צעדים שכל עובד יכול להמשיך מהם'], faqs: [{ question: 'למי מתאימה סדנת AI?', answer: 'להנהלות, צוותי תפעול, שיווק, כספים, אנליטיקה וידע שרוצים לעבור מהתנסות אקראית לשימוש פרקטי ובטוח.' }, { question: 'האם הסדנה מותאמת לארגון?', answer: 'כן. התוכן והתרגילים נבנים סביב התפקידים, הכלים והמידע שהצוות פוגש ביום-יום.' }] },
